...
* производится запрос к сервису OpenWeather для получения прогноза погоды по координатам,
...
| common | type\_storage | Тип хранилища информации, возможные значения: _in_memory_ - в памяти, _postgre_ - в БД postgre(не реализовано)
|server | 
...
| weather |
| weather |key | Ключ доступа для получения погоды(https://openweathermap.org/current)
